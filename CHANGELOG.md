...
## [3.9.1] - 2026-03-21
- **Updated** - `archetype-fiction-type-map.json` adjusting the ranges to generate more realistic scene counts per format, and to better reflect the typical distribution of scene counts in different narrative formats (e.g. short stories, novels, etc.). 
